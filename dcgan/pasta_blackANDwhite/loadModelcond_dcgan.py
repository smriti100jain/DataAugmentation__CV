...
gen_params = [sharedX(p) for p in joblib.load(model_path+'8999_gen_params.jl')]
discrim_params = [sharedX(p) for p in joblib.load(model_path+'8999_discrim_params.jl')]
