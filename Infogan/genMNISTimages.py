...
sample_directory = './figsTutte' #Directory to save sample images from generator in.
...
with tf.Session() as sess:  
    ...
    i=10000
    saver.restore(sess,'./models/model-'+str(i)+'.cptk')
    ...
    a = (np.reshape(np.array([[(e/4.5 - 1.)] for e in range(10) for _ in range(10)]),[10,10]).T)
