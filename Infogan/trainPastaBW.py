...
trainerD = tf.train.AdamOptimizer(learning_rate=0.0000002,beta1=0.5)
trainerG = tf.train.AdamOptimizer(learning_rate=0.000002,beta1=0.5)
trainerQ = tf.train.AdamOptimizer(learning_rate=0.0000002,beta1=0.5)
...
iterations = 10*500000#500000 #Total number of iterations to use.
sample_directory = '../../../opt/ADL_db/Users/sjain/InfoganSelf/Pasta32/figsTut' #Directory to save sample images from generator in.
model_directory = '../../../opt/ADL_db/Users/sjain/InfoganSelf/Pasta32/models' #Directory to save trained model to.
