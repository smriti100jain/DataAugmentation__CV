...
def discriminator(bottom, cat_list,conts, reuse=False):
    ...
    dis4 = slim.fully_connected(slim.flatten(dis3),1024*4,activation_fn=lrelu,\
    ...
    print(d_out)
    q_a = slim.fully_connected(dis4,512,normalizer_fn=slim.batch_norm,\
...
trainerG = tf.train.AdamOptimizer(learning_rate=0.00002,beta1=0.5)
...
sample_directory = '../../../opt/ADL_db/Users/sjain/InfoganSelf/Pasta128/figsTut' #Directory to save sample images from generator in.
model_directory = '../../../opt/ADL_db/Users/sjain/InfoganSelf/Pasta128/models' #Directory to save trained model to.
