...
def generator(z):
    ...
    g_out = slim.convolution2d(\
        gen3,num_outputs=1,kernel_size=[128,128],padding="SAME",\
...
def discriminator(bottom, cat_list,conts, reuse=False):
    ...
    print(dis2)
    dis3 = slim.convolution2d(dis2,1024,[3,3],padding="SAME",\
        normalizer_fn=slim.batch_norm,activation_fn=lrelu,\
...
z_size = 32 #Size of initial z vector used for generator.
img_row = 128
img_col = 128
...
batch_size = 1#np.shape(Images)[0] #Size of image batch to apply at each iteration.
iterations = 500000#500000 #Total number of iterations to use.
sample_directory = '../../../opt/ADL_db/Users/sjain/Infogantemp/Pasta128/figsTut' #Directory to save sample images from generator in.
model_directory = '../../../opt/ADL_db/Users/sjain/Infogantemp/Pasta128/models' #Directory to save trained model to.
...
with tf.Session() as sess:  
    ...
    for i in range(iterations):
        ...
        xs = Images[1]#mnist.train.next_batch(batch_size) #Draw a sample batch from MNIST dataset.
